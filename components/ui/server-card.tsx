...
export const ServerCard = (props: { server: SelectServer }) => {
  return (
    <Card className="overflow-hidden hover:shadow-lg transition-shadow relative h-80 w-full group cursor-pointer">
      <Image
      ...
      />
      <CardContent className="flex flex-col items-center justify-center  rounded-lg absolute bottom-0 w-full px-4 backdrop-blur text-xl font-bold h-12 p-0 bg-background/50">
